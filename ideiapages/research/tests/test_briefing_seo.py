        ...
        BriefingSEO.model_validate(
            {
                ...
                "keywords_semanticas_lsi": [f"lsi{i}" for i in range(8)],
                "perguntas_tipo_paa": [f"paa{i}" for i in range(4)],
                "gancho_vendas": "Gancho comercial com mais de quarenta caracteres para validar o campo.",
                "gaps_conteudo_top3": "Texto descritivo com mais de vinte caracteres.",
                "faq_sugerida": [],
                "cta_principal": "cta",
                "cta_secundario": None,
